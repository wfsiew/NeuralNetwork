...
namespace AForge.Controls
{
    ...
    public partial class Chart : Control
    {
        ...
        // data series table
        private Dictionary<string, DataSeries> seriesTable;
        ...
        private void Init()
        {
            seriesTable = new Dictionary<string, DataSeries>();

            blackPen = new Pen(Color.Black);
            whiteBrush = new SolidBrush(Color.White);

            rangeX = new DoubleRange(0, 1);
            rangeY = new DoubleRange(0, 1);
        }
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            if (rangeY != null)
            {
                ...
                foreach (DataSeries series in seriesTable.Values)
                {
